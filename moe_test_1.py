...
class SparseMixtureOfExperts(nn.Module):
    def __init__(self, in_channels, num_experts, expert_models, top_k=2):
        ...
        self.gating = nn.Sequential(
            # Add BatchNorm after Conv2d layers to improve training stability
...
# Data loaders
 # Increase the batch size to 4096 
train_loader = DataLoader(pretrain_dataset, batch_size=4096, shuffle=True)
