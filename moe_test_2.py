'''
Changes in this file includes gating network evaluation on training and validation data and adding BatchNorms after each convolutional layers in the gating network.
'''
